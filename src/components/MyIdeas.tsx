    ...
    <div className="min-h-screen bg-gradient-to-b from-[#F7F9FC] to-white py-12 px-4">
      <div className="container mx-auto max-w-5xl">
        ...
        {savedProjects.length >= 2 && !showComparison && (
          <div className="mb-6 flex items-center justify-between bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            <div className="flex items-center gap-3">
              <GitCompare className="w-5 h-5 text-[#7C6CF6]" />
              <div>
